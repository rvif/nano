...
if [ -d "./public" ]; then
  ...
  if [ ! -f "./public/images/default_pfp.jpg" ]; then
    echo "WARNING: Default profile picture missing, creating it..."
    # Base64 encoded small default avatar 
    ...
    if [ $? -ne 0 ]; then
      echo "ERROR: Failed to create default profile picture, trying alternative method..."
      # Create a simple placeholder file
      echo "Default profile picture placeholder" > ./public/images/default_pfp.jpg
    fi
...
# Set RUN_MIGRATIONS to true to ensure migrations run
export RUN_MIGRATIONS=true

echo "============= STARTING APPLICATION =============="
# Run the application, error output to stdout
exec ./app 2>&1